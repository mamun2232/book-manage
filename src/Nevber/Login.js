...
const Login = () => {
      ...
      <div class="max-w-2xl h-[450px] dark:bg-gray-700 flex items-center mx-auto overflow-hidden bg-white rounded-lg shadow-md mt-10">
        

               
    <div class="w-full max-w-sm mx-auto  overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-700">
        <div class="px-6 py-4">
            <h2 class="text-3xl font-bold text-center text-gray-700 dark:text-white">Book App</h2>
